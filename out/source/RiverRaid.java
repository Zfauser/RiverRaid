...
public class RiverRaid extends PApplet {
...
float BulletY = 342.85715f; //y position of the bullet
int BulletX;
int BulletRight;
...
float remainingFuel = 200;
 ...
 public void draw() {
    ...
    fill(119, 119, 119);
    rect(0, 500, 800, 100);
    image(plane, planeX, height/1.75f);
    if (BulletY > 0) {
            shootBullet();
            BulletY -= speed;
    } else shoot = false;
    ...
    if (BulletX > fuelX && BulletX < fuelX + 30 && height/1.75f > fuelY && height/1.75f < fuelY + 60 || BulletRight > fuelX && BulletRight < fuelX+ 30 && height/1.75f > fuelY && height/1.75f < fuelY + 60) {
        shoot = false;
        fuelX = random(225, 545);
        fuelY = -100;
    }
    ...
    if (planeX > helicopterX && planeX < helicopterX + 30 && height/1.75f > helicopterY && height/1.75f < helicopterY + 30 || planeRight > helicopterX && planeRight < helicopterX + 30 && height/1.75f > helicopterY && height/1.75f < helicopterY + 30) {
        if (lives > 0) {
            lives -= 1;
            helicopterX = random(225, 545);
            helicopterY = -100;
    ...
    if (planeX > fuelX && planeX < fuelX + 30 && height/1.75f > fuelY && height/1.75f < fuelY + 60 || planeRight > fuelX && planeRight < fuelX+ 30 && height/1.75f > fuelY && height/1.75f < fuelY + 60) {
        fuelX = random(225, 545);
        fuelY = -100;
        remainingFuel += 100;
 ...
 public void keyPressed() {
    if (key == 'a') {
        fill(57, 76, 180);
        stroke(57, 76, 180);
        rect(planeX, height/1.75f, 30, 30);
        planeX -= 10;
        planeRight -= 10;
        image(plane, planeX, height/1.75f);
    }
 ...
 public void fuelbar() {
    ...
    remainingFuel = remainingFuel - 0.25f;
    fill(255, 0, 0);
    rect(550, 525, 200, 50);
    fill(0, 255, 0);
 ...
 public void debug(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RiverRaid" };
    if (passedArgs != null) {
